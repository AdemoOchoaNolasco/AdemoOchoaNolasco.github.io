...
### __<b style = 'color : blue;'>G. Analizando la variable  bmi  - Body mass index:</b>__
...
```
### __<b style = 'color : blue;'>H. Analizando la variable  HbA1c_level  - Hemoglobina glicosidica:</b>__
__Comentario__ Las medianas de los personas con diabetes son mayores a las que no tienen la enfermedad  . Para todos los grupos de adultos.
...
g + geom_boxplot() + stat_boxplot(geom = "errorbar",
               width = 0.25) + facet_wrap(~ diabetes)
```
### __<b style = 'color : blue;'>I. Analizando la variable  Glucosa en sangre:</b>__
